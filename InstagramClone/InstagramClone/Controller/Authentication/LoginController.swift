...
class LoginController: UIViewController{
    ...
    private let loginButton: UIButton = {
        let button = UIButton().makeButton(withTitle: "Log In", titleColor: .white, buttonColor: #colorLiteral(red: 0.3647058904, green: 0.06666667014, blue: 0.9686274529, alpha: 1), isRounded: true)
